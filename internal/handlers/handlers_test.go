...
func (m *MockRepository) ListPosts(filter models.ListRequestQueryParams, order []int) (*models.PostList, error) {
	args := m.Called(filter, order)
	if args.Get(0) == nil {
...
func TestHandler_ListPosts(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockRepo.On("ListPosts", tt.expectedFilter, []int{0, 1, 2}).Return(tt.mockResponse, tt.mockError)
